...
<link href="{{url('css/social-buttons.css')}}" rel="stylesheet">   
<link href="{{url('css/sidebar.css')}}" rel="stylesheet">
<link href="{{url('dropzone/min/dropzone.min.css')}}" rel="stylesheet">
<link href="{{url('css/jquery.qtip.min.css')}}" rel="stylesheet">
