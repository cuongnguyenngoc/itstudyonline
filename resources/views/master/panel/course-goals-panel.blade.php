...
<script type="text/javascript">
    ...
    $(document).on('ready',function(){
        ...
        $("#courseGoals").on('submit',function(e){
            e.preventDefault();
            console.log("length "+$('#descriptionText').val().length + " value "+$('#descriptionText').val());
            if($("#courseGoals").valid()){
                if($('#descriptionText').val().length >= 15){
                    var course = {};
                    ...
                    alert("Course Summary should minimax be 300 characters");
                }
            }
        });
    });
