    ...
    <div class="panel-body">
        ...
        {!! Form::model($course,['route' => 'master.course.create', 'role' => 'form', 'id' => 'courseGoals' ]) !!}
            ...
            <div class="form-group">
                ...
                <textarea class='form-control' id='descriptionText' name='content' placeholder='Enter course description' style='width:100%'></textarea>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#courseGoals").on('submit',function(e){
            ...
            course.describe = $('#descriptionText').val();
            $.ajax({
                type: "POST",
